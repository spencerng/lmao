...
class Ui_ConfirmMenu(object):
    def setupUi(self, ConfirmMenu):
        ...
        self.itemDetectedLabel.setGeometry(QtCore.QRect(280, 10, 231, 41))
        font = QtGui.QFont()
        ...
        self.confirmScanBtn.setGeometry(QtCore.QRect(220, 400, 151, 51))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(20)
        ...
        self.retryScanBtn.setGeometry(QtCore.QRect(420, 400, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(20)
        ...
        self.hamperSectionView.setGeometry(QtCore.QRect(180, 160, 431, 201))
        self.hamperSectionView.setText("")
        self.hamperSectionView.setPixmap(QtGui.QPixmap("img/place_bl.png"))
